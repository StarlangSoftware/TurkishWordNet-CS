...
namespace Test
{
    public class WordNetTest
    {
        ...
        public void TestSynSetList()
        {
            ...
            Assert.AreEqual(109049, literalCount);
        }

        [Test]
        public void TestLiteralList()
        {
            Assert.AreEqual(81092, turkish.LiteralList().Count);
        }
        ...
        public void TestNumberOfSynSetsWithLiteral()
        {
            ...
            Assert.AreEqual(51, turkish.NumberOfSynSetsWithLiteral("tutmak"));
        ...
        public void TestFindPathToRoot()
        {
            ...
            Assert.AreEqual(4, turkish.FindPathToRoot(turkish.GetSynSetWithId("TUR10-0172740")).Count);
            ...
            Assert.AreEqual(10, turkish.FindPathToRoot(turkish.GetSynSetWithId("TUR10-1198750")).Count);
